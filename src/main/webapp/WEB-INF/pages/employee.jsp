                ...
                <div class="col-lg-12">
                    <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <s:if test="#request.pb.beanList!=null">
                            <s:iterator value="#request.pb.beanList" var="employee">
                                <tbody>
                                ...
                                <td><s:date name="#employee.birthday" format="yyyy-MM-dd"/></td>
                                <td><s:date name="#employee.joindate" format="yyyy-MM-dd" /></td>
                                <td><s:property value="#employee.phone"/></td>
                                <td><s:property value="#employee.department.did"/></td>
                                <td><s:property value="#employee.level"/></td>
